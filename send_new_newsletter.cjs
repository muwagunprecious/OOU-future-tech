...
async function sendNewsletter() {
    console.log('Sending premium Future Tech Academy (FTA) style newsletter...');
    try {
        const mailOptions = {
        ...
        console.log('✅ Premium FTA Style Newsletter sent successfully: ' + info.messageId);
    } catch (err) {
