...
export default async function handler(req, res) {
    ...
    if (!email || !name) {
        console.error('❌ Missing required fields for test reminder email:', { email, name });
    ...
    console.log(`📧 Sending screening test reminder to: ${email}`);

    const mailOptions = {
        from: `"OOU Future Tech Academy" <${senderEmail}>`,
        to: email,
        subject: `⏰ Reminder: Complete Your Screening Test (${courseTrack}) - Future Tech Academy`,
        html: `
            <div style="font-family: 'Outfit', Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 5px solid #000; padding: 30px; border-radius: 20px; background: #ffffff;">
                ...
                <h2 style="color: #E63946; text-align: center; font-size: 24px; font-weight: 900; text-transform: uppercase;">
                    ⏰ Action Required: Take Your Screening Test
                </h2>
                ...
                <p style="font-size: 15px; color: #333333; line-height: 1.6;">
                    This is a friendly reminder that your online Screening Test for the <strong>${courseTrack}</strong> track at Future Tech Academy is still pending!
                </p>
                
                <p style="font-size: 15px; color: #333333; line-height: 1.6;">
                    To enable our admissions committee to review your application and offer you admission into Cohort One, please complete your test as soon as possible.
                </p>
                ...
                <div style="background: #f4f4f5; padding: 25px; border: 3px solid #000000; border-radius: 15px; margin: 25px 0; box-shadow: 4px 4px 0 #000000;">
                    <h4 style="margin-top: 0; text-transform: uppercase; font-size: 13px; color: #E63946; letter-spacing: 0.5px;">Test Details & Registered Credentials</h4>
                ...
                <div style="background: #fffbeb; border: 2.5px solid #d97706; padding: 20px; border-radius: 12px; margin-bottom: 25px;">
                    ...
                    <p style="margin: 0; font-size: 14px; color: #78350f; line-height: 1.5;">
                        When you open the test page, you will be prompted to enter your registered email address. You <strong>MUST</strong> enter: <strong style="color: #000; background: #fef3c7; padding: 2px 6px; border-radius: 4px;">${email}</strong> to access the test questions.
                    </p>
                </div>
    ...
    try {
        ...
        console.log(`✅ Screening test reminder email sent successfully to ${email}. MessageID: ${info.messageId}`);
